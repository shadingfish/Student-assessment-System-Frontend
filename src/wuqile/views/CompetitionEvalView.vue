        ...
        <el-container>
            ...
            <el-dialog title="竞赛状况评分表" :visible.sync="dialogTableVisible" class="thisblack-bgc">
                <el-table :data="gridData">
                    <el-table-column property="compName" label="竞赛名称"></el-table-column>
                    <el-table-column property="awardTime" label="时间"></el-table-column>
                    <el-table-column property="level" label="竞赛级别"></el-table-column>
                    <el-table-column property="ranking" label="排名"></el-table-column>
                ...
                <el-form-item label="学年">
                    <el-select v-model="eval_record.acYear" placeholder="请选择学年">
...
import { getCompByCardId } from '../api/Comp';
    ...
    methods: {
      ...
      updateForm(){
        ...
        handleClick(index,row){
            ...
            this.CurIndex=index
            getCompByCardId(row.cardId).then((res)=>{
